...
import in.akash.controller.EmployeeController;
import in.akash.vo.EmployeeVO;

@SpringBootApplication
public class BootProj12RealTimeDiAutoConfigurationProfilesApplication {

	static {
		System.out.println("BootProj11RealTimeDiAutoConfigurationProfilesApplication.class file is loading...");
	}

	public BootProj12RealTimeDiAutoConfigurationProfilesApplication() {
		System.out.println("BootProj11RealTimeDiAutoConfigurationProfilesApplication:: Zero param constructor...");
	}
	...
	public static void main(String[] args) {
		ApplicationContext context = SpringApplication
				.run(BootProj12RealTimeDiAutoConfigurationProfilesApplication.class, args);
